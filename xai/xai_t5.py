...
from transformers.models.t5.modeling_t5 import  T5ForConditionalGeneration, T5Attention, T5LayerNorm, T5DenseGatedActDense, T5DenseActDense
...
class T5ForConditionalGenerationXAI(T5ForConditionalGeneration):
    ...
    def override_default_layers(self, config):
        ...
        for i in range(decoder_config.num_decoder_layers):
            ...
            self.decoder.block[i].layer[1].EncDecAttention = T5AttentionXAI(decoder_config, has_relative_attention_bias=False)
        ...
        while True:
         ...
         #   
            ...
            if next_tokens in explain_ids:
                ...
                encoder_outputs = self.encoder(**{'inputs_embeds': input_embeds_detached, 'attention_mask': attention_mask})
